...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const bottom11(title: 'Frosted bottom bar'),
    );
  }
}

class bottom11 extends StatefulWidget {
  const bottom11({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<bottom11> createState() => _bottom11State();
}

class _bottom11State extends State<bottom11>
