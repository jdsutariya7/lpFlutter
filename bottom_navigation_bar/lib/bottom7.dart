...
void main() {
  runApp(const bottom7());
}

class bottom7 extends StatefulWidget {
  const bottom7({Key? key}) : super(key: key);

  @override
  State<bottom7> createState() => _bottom7State();
}

class _bottom7State extends State<bottom7> {
